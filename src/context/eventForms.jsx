...
import art5 from '../assets/EVENTS/launchpad.webp'
...
import art17 from '../assets/18.webp'
import art18 from '../assets/19.webp'
import art19 from '../assets/20.webp'
import art20 from '../assets/21.webp'
...
export const EVENTS_DATASET = [
  ...
  },
  {
    ...
    description: 'Step into the tank! Pitch breakthrough tech startups, business models, and scalable prototypes directly to industry angels, venture founders, and investment juries for capital and incubation.',
  ...
  },
  {
    ...
    description: 'Immerse in culinary wizardry and gourmet creations! Live chef battles, street food kiosks, masterclass dessert crafting, and flavor-packed competitions across the campus.',
  ...
  },
  {
    ...
    description: 'Custom-tuned RC monster trucks and electric speedsters battle in a high-octane obstacle track. Navigate ramps, gravel pits, hairpin turns, and speed traps under maximum throttle.',
  ...
  },
  {
    ...
    description: 'Engineering meets athletic tactics! Deploy custom-engineered manual or autonomous rovers to dribble, tackle, and strike goals in a fast-paced magnetic turf arena.',
  ...
  },
  {
    ...
    description: 'Pilots pilot high-thrust quadcopters through an illuminated obstacle matrix in 3D airspace. Test acrobatic control, obstacle clearance, hover stability, and rapid waypoint timing.',
  ...
  },
  {
    ...
    description: 'Present breakthrough technologies for renewable energy, water recycling, carbon capture, and circular economy design before environmental researchers and green-tech venture investors.',
  ...
  },
  {
    ...
    description: 'The premier clinical dexterity and athletic movement challenge! Test clinical palpation, EMG signal interpretation, ergonomic workstation evaluation, and high-speed emergency response drills.',
  ...
  },
  {
    ...
    description: 'Live jeopardy-style ethical hacking battle! Penetrate fortified server clusters, decrypt steganographic payloads, exploit memory corruptions, and defend cyber infrastructure under time pressure.',
  ...
  },
  {
    ...
    description: 'Electrifying cultural night to celebrate the culmination of TechUtopia! Live rock bands, EDM DJ sets, theatrical dance fusion, and musical performances under laser light shows.',
