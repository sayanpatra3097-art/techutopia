          ...
          <div className="tech-nav-boundary">
            ...
            <div className="tech-nav-boundary__frame" aria-hidden="true">
              ...
              >
                ...
                {/* Left Outer Wing (horizontal gold antenna stepping down) */}
                <path
                ...
                <polygon
                  ...
                  strokeWidth="1"
                />
                <line x1="220" y1="48" x2="250" y2="48" stroke="#ffb703" strokeWidth="1.8" />
                ...
                <line x1="450" y1="48" x2="486" y2="48" stroke="#ffb703" strokeWidth="1.8" />
                {/* CENTER GAP (divider cut) between 486 and 514 */}
                <line x1="514" y1="48" x2="550" y2="48" stroke="#ffb703" strokeWidth="1.8" />
                ...
                <polygon
                  ...
                  strokeWidth="1"
                />
                <line x1="740" y1="48" x2="770" y2="48" stroke="#ffb703" strokeWidth="1.8" />
                ...
                {/* Right Outer Wing (horizontal gold antenna stepping up) */}
                <path
                ...
                <line x1="44" y1="1" x2="956" y2="1" stroke="rgba(255, 215, 0, 0.45)" strokeWidth="1.2" />
              </svg>
            </div>
