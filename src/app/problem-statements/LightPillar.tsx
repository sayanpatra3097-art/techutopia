...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  useEffect(() => {
    ...
    const qualitySettings = {
      low: { iterations: 14, waveIterations: 1, pixelRatio: 0.3, precision: 'mediump' as const, stepMultiplier: 2.0 },
      medium: { iterations: 28, waveIterations: 2, pixelRatio: 0.5, precision: 'mediump' as const, stepMultiplier: 1.5 },
      high: {
        iterations: 80,
        waveIterations: 4,
    ...
    const targetFPS = effectiveQuality === 'low' ? 20 : effectiveQuality === 'medium' ? 30 : 60;
    ...
    const animate = (currentTime: number) => {
      ...
      if (deltaTime >= frameTime) {
        // Skip render if scrolled out of view
    ...
    // Pause rendering when not visible (huge perf win on long pages)
